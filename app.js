...
// Route information
const generalRoutes = require('./app/routes/general/routes');
const cookiesRoutes = require('./app/routes/cookies/routes');
const authRoutes = require('./app/routes/auth/routes');
const verifyDetailRoutes = require('./app/routes/verify-detail/routes');
const dateRoutes = require('./app/routes/date/routes');
const startDateRoutes = require('./app/routes/start-date/routes');
const dobRoutes = require('./app/routes/dob/routes');
const overseasRoutes = require('./app/routes/overseas/routes');
const prisonRoutes = require('./app/routes/prison/routes');
const maritalRoutes = require('./app/routes/marital/routes');
const processRoute = require('./app/routes/process/routes');
const contactRoutes = require('./app/routes/contact/routes');
const altFormatQuestionRoutes = require('./app/routes/alt-formats/routes');
const altFormatChoiceRoutes = require('./app/routes/alt-formats-choose/routes');
const completeRoute = require('./app/routes/complete/routes');
const declarationRoutes = require('./app/routes/declaration/routes');
const accountRoutes = require('./app/routes/account/routes');
const actuatorRoutes = require('./app/routes/actuator/routes');
const invitationCode = require('./app/routes/invitation-code/routes');
const requestInvitationIndex = require('./app/routes/request-invitation/index/routes');
const overseasStub = require('./app/routes/overseas-stub/routes');
const checkChange = require('./app/routes/check-change/routes');
const sessionRoutes = require('./app/routes/session/routes');
const accountAdditionalChecks = require('./app/routes/account-additional-checks/routes');
const kbvQuestionRoutes = require('./app/routes/transunion-kbv/routes');
const requestInvitation = require('./app/routes/request-invitation/routes');
...
app.use(config.mountUrl, altFormatQuestionRoutes);
app.use(config.mountUrl, altFormatChoiceRoutes);
