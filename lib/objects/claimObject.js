...
module.exports = {
  ...
  sessionToObject(details, accountStatus, language) {
    ...
    if (!generalHelper.isThisUndefinedOrEmtpy(details.benefits)
    && !generalHelper.isThisUndefinedOrEmtpy(details.benefits.receivingBenefits)) {
      json.receivingBenefits = false;
      if (details.benefits.receivingBenefits === 'yes') {
        json.receivingBenefits = true;
      }
      json.receivingBenefitsQ = i18n.t('benefits:fields.receivingBenefits.legend');
    }
