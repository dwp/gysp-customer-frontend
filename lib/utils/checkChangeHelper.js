...
module.exports = {
  ...
  cleanSessionForCheckAndChange(req) {
    if (req.session['lived-abroad']) {
      if (req.session['lived-abroad'].livedAbroad === 'yes' && !req.session['lived-abroad-countries']) {
        req.session['lived-abroad'].livedAbroad = 'no';
      }
    }

    if (req.session['worked-abroad']) {
      if (req.session['worked-abroad'].workedAbroad === 'yes' && !req.session['worked-abroad-countries']) {
        req.session['worked-abroad'].workedAbroad = 'no';
      }
    }
