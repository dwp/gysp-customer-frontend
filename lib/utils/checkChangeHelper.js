...
module.exports = {
  requestFilter(details, lang) {
    ...
    if (details['dob-details']) {
      ...
      data.push({
        key: {
          text: i18n.t('dob-confirmation:header'),
        ...
        actions: {
          items: [{
            ...
            text: 'Change',
            visuallyHiddenText: i18n.t('dob-confirmation:header'),
            attributes: {
              id: 'dateOfBirth',
    ...
    if (details['lived-abroad'] === undefined && details['lived-abroad-countries']) {
      ...
      data.push({
        key: {
          text: i18n.t('countries:lived.header-overseas'),
          classes: 'govuk-!-width-two-thirds',
        },
        value: {
          html: livedAbroadAnswer.join('<br />'),
        ...
        actions: {
          items: [{
            ...
            text: 'Change',
            visuallyHiddenText: i18n.t('countries:lived.header-overseas'),
            attributes: {
    ...
    if (details['worked-abroad']) {
      ...
      data.push({
        key: {
          text: i18n.t('worked-abroad:header'),
          classes: 'govuk-!-width-two-thirds',
        },
        value: {
        ...
        actions: {
          items: [{
            ...
            text: 'Change',
            visuallyHiddenText: i18n.t('worked-abroad:header'),
            attributes: {
    ...
    if (details['marital-select']) {
      ...
      data.push({
        key: {
          text: i18n.t('marital-select:header'),
          classes: 'govuk-!-width-two-thirds',
        },
        value: {
        ...
        actions: {
          items: [{
            ...
            text: 'Change',
            visuallyHiddenText: i18n.t('marital-select:header'),
            attributes: {
    ...
    if (details.benefits) {
      ...
      data.push({
        ...
        actions: {
          items: [{
            href: '/are-you-receiving-any-benefits?edit=true',
            text: 'Change',
            visuallyHiddenText: i18n.t('benefits:header'),
            attributes: {
              id: 'areYouReceivingAnyBenefits',
              'data-journey-click': i18n.t('google-analytics:pages.check-change.change', { VALUE: 'are-you-receiving-any-benefits' }),
            },
          }],
        },
      });
      ...
      data.push({
        ...
        actions: {
          items: [{
            ...
            text: 'Change',
            visuallyHiddenText: i18n.t('contact:header'),
            attributes: {
              id: 'contactDetails',
