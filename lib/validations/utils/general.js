...
// eslint-disable-next-line max-len
const buildingNameNumberRegEx = `^([${alphaNumericChars}]|[${alphaNumericChars}]((?!([${punctuation2}]){3})[${alphaNumericChars}${punctuation2}]){0,140}[${alphaNumericChars}])$`;
const streetRegEx = `^([${alphaChars}]|[${alphaChars}]((?!([${punctuation}]){2})[${alphaChars}${punctuation}]){0,140}[${alphaChars}])$`;
