...
module.exports = {
  ...
  bankValidation(postRequest) {
    ...
    const sortCode = cleanSortCode(postRequest.bankSortCode);
    if (isSortCodeEmpty(sortCode)) {
      errors.bankSortCode = {
        text: i18n.t('account:fields.sortCode.errors.required'),
        visuallyHiddenText: i18n.t('app:error-message.visuallyHiddenText'),
      };
    } else if (!isSortCodeNumeric(sortCode)) {
      errors.bankSortCode = {
        text: i18n.t('account:fields.sortCode.errors.format'),
        visuallyHiddenText: i18n.t('app:error-message.visuallyHiddenText'),
      };
    } else if (!isSortCodeValidLength(sortCode)) {
      errors.bankSortCode = {
